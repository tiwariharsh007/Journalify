...
const ViewJournal = ({storyInfo, onClose, onEditClick, onDeleteClick}) => {
  return (
      <div className="relative">
            ...
            <div>
                <div className="flex items-center gap-3 bg-cyan-50/50 p-2 rounded-l-lg">
                  ...
                  <button className="btn-small btn-delete" onClick={onDeleteClick}>
                    <MdDeleteOutline className="text-lg"/>Delete Journal
                  </button>
        ...
        <div className="mt-4">
            <p className="text-sm text-slate-950 text-justify whitespace-pre-line">{storyInfo.story}</p>
        </div>
